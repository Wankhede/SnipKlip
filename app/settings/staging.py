...
SECRET_KEY = get_env('SECRET_KEY', 'replace-me-in-staging')
...
FRONTEND_LINK = get_env('FRONTEND_LINK', 'https://staging.snipklip.in')

allowed_hosts = get_env('ALLOWED_HOSTS', 'stag.snipklip.in,206.189.136.106,127.0.0.1,testserver,localhost')
if allowed_hosts == '*':
    ALLOWED_HOSTS = ['*']
...
DATABASES = {
    'default': {
        ...
        'NAME': get_env('DB_NAME', 'stag_data'),
